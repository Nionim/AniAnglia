...
```bash
# UPD: В новейших версиях проект был перенесен на Cmake.
...
## TODO
Изначально этот репозиторий был создан чисто для удобства.
<br> На данный момент тут ведется более активная работа, чем в оригинале.
<br> То, что вы не видите коммитов - Это не значит, что их нет, большая часть прогресса только в закрытой бетке :)
